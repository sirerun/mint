  ...
  return (
    <section className="mt-20 rounded-xl border border-[var(--color-border)] bg-gradient-to-r from-[var(--color-bg-secondary)] to-[var(--color-bg-tertiary)] p-8 text-center">
      <p className="text-lg font-semibold">
        ...
        <a
          href="https://mintmcp.com/managed?utm_source=mint-registry&utm_medium=banner&utm_campaign=managed-promo"
      ...
      <a
        href="https://mintmcp.com/signup?source=mint-registry&utm_source=mint-registry&utm_medium=banner&utm_campaign=managed-promo"
